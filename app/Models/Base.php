 ...
 * @method EloquentBuilder load($relation)
 * @method EloquentBuilder with($relation)
 * @method static EloquentBuilder find($value)
 * @method static EloquentBuilder updateOrCreate(array $attributes = [])
 * @method static EloquentBuilder orderBy($column, $direction = 'asc')
 * @method static EloquentBuilder select($columns = ['*'])
 * @method static EloquentBuilder create(array $attributes = [])
 * @method static EloquentBuilder delete()
 *
 *
 ...
 * @method static QueryBuilder count($columns = '*')
 * @method static QueryBuilder insert(array $values)
 * @method mixed whereUser($id) Add a basic where clause to the query.
 */
abstract class Base extends Model
{
    public function scopeWhereUser(EloquentBuilder $query, $id) {
